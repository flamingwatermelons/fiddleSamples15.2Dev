                ...
                [
                    {
                        name: "button1",
                        header: "Bold",
                        iconUri: "http://dev.igniteui.local/15-2/images/samples/radial-menu/Bold.png",
                        click: function () { toggleBold(); }
                    },
                    {
                        name: "button2",
                        header: "Italic",
                        iconUri: "http://dev.igniteui.local/15-2/images/samples/radial-menu/Italic.png",
                        click: function () { toggleItalic(); }
                    },
                    {
                        type: "numericitem",
                        header: "Font Size",
                        iconUri: "http://dev.igniteui.local/15-2/images/samples/radial-menu/Size.png",
                        value: "8",
                        items:
                        [
                            {
