...
function ColorPickerByIndex(min, max) {
         ...
         $(function () {
            ...
            $("#map").igMap({
                ...
                overviewPlusDetailPaneBackgroundImageUri: "http://dev.igniteui.local/15-2/images/samples/maps/world.png",
                series: [{
                    type: "geographicShape",
                    name: "worldCountries",
                    markerType: "none",
                    shapeMemberPath: "points",
                    shapeDataSource: 'http://dev.igniteui.local/15-2/data-files/shapes/world_countries_reg.shp',
                    databaseSource: 'http://dev.igniteui.local/15-2/data-files/shapes/world_countries_reg.dbf',
                    opacity: 0.8,
                    outlineThickness: 1,
                    showTooltip: true,
