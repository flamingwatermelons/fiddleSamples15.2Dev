...
var alternate = true;
        ...
        $(function () {
            ...
            $("#player1").igVideoPlayer({
                ...
                width: "100%",
                posterUrl: 'http://dev.igniteui.local/15-2/images/samples/video-player/ig-pres.png',
                fullscreen: false,
                ...
                banners: [{
                    imageUrl: 'http://dev.igniteui.local/15-2/images/samples/video-player/banner.png',
