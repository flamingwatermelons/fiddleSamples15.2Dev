$(function () {
            ...
            $("#player1").igVideoPlayer({
                ...
                width: 720,
                height: 560,
                posterUrl: "http://dev.igniteui.local/15-2/images/samples/video-player/quince-intro-1.png",
                fullscreen: false,
                ...
                relatedVideos: [
					{
					    imageUrl: "http://dev.igniteui.local/15-2/images/samples/video-player/quince-intro-2.png",
					    title: "Quince Presentation Part 1",
