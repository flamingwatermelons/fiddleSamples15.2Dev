...
var alternate = true;
        ...
        $(function () {
            ...
            $("#player1").igVideoPlayer({
                ...
                width: "100%",
                posterUrl: 'http://jp.dev.igniteui.local/15-2/images/samples/video-player/ig-pres.png',
                fullscreen: false,
                ...
                banners: [{
                    imageUrl: 'http://jp.dev.igniteui.local/15-2/images/samples/video-player/banner.png',
